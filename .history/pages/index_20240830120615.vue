  ...
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mt-8">
      ...
      <form class="flex flex-col sm:flex-row justify-center gap-2">
        <input type="email" placeholder="Enter your email" class="p-2 border border-gray-30bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-r-lg">Subscribe</button>
      </form>
    </div>
  </div>
</section>
