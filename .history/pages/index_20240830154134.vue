        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
              <img src="../public/Event1"  alt="Event" class="w-full h-40 object-cover mb-4 rounded">
              <h3 class="text-xl font-semibold mb-2">Event Title</h3>
              <p class="text-gray-600">Event description goes here.</p>
              <button class="py-4 px-4 md:py-3 md:px-6 text-base md:text-lg lg:text-xl font-bold bg-primary rounded-lg text-white border-none cursor-pointer transition duration-300 ease-in-out hover:bg-red-700"><a href="#">See Details</a></button>
