      ...
      <section id="blog" class="latest-blog py-16">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Blog Card -->
            <div class="bg-white p-6 rounded-lg shadow-md">
              <img src="/path/to/image.jpg" alt="Blog Post" class="w-full h-40 object-cover mb-4 rounded">
      ...
      <section id="events" class="events bg-gray-100 py-16">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Event Card -->
            <div class="bg-white p-6 rounded-lg shadow-md">
              <img src="/path/to/event-image.jpg" alt="Event" class="w-full h-40 object-cover mb-4 rounded">
