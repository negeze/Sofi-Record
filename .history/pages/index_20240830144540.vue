...
<section id="blog" class="latest-blog py-16">
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Blog Card -->
      <div class="bg-neutral-800 p-6 rounded-lg shadow-md flex flex-col">
    ...
    <div class="text-center mt-8">
      ...
      <form class="flex flex-col sm:flex-row justify-center gap-2">
        <input type="email" placeholder="Enter your email" class="p-2 border border-black-300 rounded-l-lg max-w-xs flex-1">
