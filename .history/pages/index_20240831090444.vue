...
<section id="blog" class="latest-blog py-16">
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <a href="/blog/specific-blog-page.html" class="bg-white p-3 rounded-lg shadow-md flex flex-col hover:shadow-lg transition-shadow duration-300" aria-label="Read More about Blog Title"> 
      <div class="bg-white  hover:bg-zinc-800 p-6  shadow-md flex flex-col">
        <img src="../public/photoOne.png" alt="Blog Post" class="w-full h-48 object-cover mb-4 rounded">
        <div class="flex-grow">
          <h3 class="text-xl font-semibold mb-2           <p class="text-gray-600 mb-4">This is a short paragraph about the blog post. It gives a brief overview or a teaser of the content to entice readers to click and read more.</p>
 hover:text-white">Blog Title</h3>
          <p class="text-white mb-4">This is a short paragraph about the blog post. It gives a brief overview or a teaser of the content to entice readers to click and read more.</p>
  ...
  <button type="submit" class="py-2 px-4 md:py-3 md:px-6 text-base md:text-lg lg:text-xl font-bold bg-primary rounded-lg text-white border-none cursor-pointer transition duration-300 ease-in-out">Subscribe</button>
   ...
   -->
      <!-- Events Section -->
      <section id="events" class="events bg-neutral-900 py-16">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
              ...
              <button class="py-1 px-4 mt-4 md:py-3 md:px-6 text-base md:text-lg lg:text-xl font-bold bg-primary rounded-lg text-white border-none cursor-pointer transition duration-300 ease-in-out hover:bg-red-700"><a href="#">See Details</a></button>
