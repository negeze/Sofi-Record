  ...
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md flex flex-col">
        <img src="../public/hero-img.jpg" alt="Blog Post" class="w-full h-48 object-cover mb-4 rounded">
        <div class="flex-grow">
    ...
    <div class="text-center mt-8">
      ...
      <form class="flex flex-col sm:flex-row justify-center gap-2">
        ...
        <button type="submit" class="py-4 m-3 px-4 md:py-3 md:px-6 text-base md:text-lg lg:text-xl font-bold bg-primary rounded-lg text-white border-none cursor-pointer transition duration-300 ease-in-out hover:bg-red-700">Subscribe</button>
      </form>
    </div>
  </div>
</section>
