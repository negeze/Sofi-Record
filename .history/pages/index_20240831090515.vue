    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white  hover:bg-zinc-800 p-6  shadow-md flex flex-col">
        ...
        <div class="flex-grow">
          ...
          <p class="text-gray-600 text-white mb-4">This is a short paragraph about the blog post. It gives a brief overview or a teaser of the content to entice readers to click and read more.</p>
