    ...
    <div >
      ...
      <section id="services" class="services h-[800px] ">
        ...
        <h1 class="text-3xl md:text-5xl font-bold ">Service</h1>
          ...
          <button class="py-4 m-px-4 md:py-3 md:px-6 text-base md:text-lg lg:text-xl font-bold bg-primary rounded-lg text-white border-none cursor-pointer transition duration-300 ease-in-out hover:bg-red-700">Learn More</button>
        </div>
