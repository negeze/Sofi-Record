<template>
  <section class=" relative flex items-center justify-start h-screen px-4 md:px-8 bg-cover bg-center bg-no-repeat hero-section">
    <div class="max-w-full md:max-w-xl lg:max-w-2xl text-white z-20 ml:5 md:ml-[69px]  ">
